...
import $ from "jquery";
    ...
    addTemplate('accounts.trust_item_device_info');
    ...
    addTemplate('contacts.invitations_chat_notification');
    addTemplate('contacts.subscriptions_chat_notification');
    ...
    addSvgTemplate('svg.pin');
    addSvgTemplate('svg.archive');
    ...
    addSvgTemplate('svg.account-edit');
    addSvgTemplate('svg.account-key');
    addSvgTemplate('svg.account-key-outline');
    addSvgTemplate('svg.account-star');
    ...
    addSvgTemplate('svg.account-check');
    ...
    addSvgTemplate('svg.call-rejected');
    addSvgTemplate('svg.call-declined');
    ...
    addSvgTemplate('svg.copy');
    addSvgTemplate('svg.reply');
    addSvgTemplate('svg.forward');
